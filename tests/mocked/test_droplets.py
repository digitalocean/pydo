...
@responses.activate
def test_droplets_list(mock_client: DigitalOceanClient, mock_client_url):
    expected = {
        "droplets": [
            {
                "id": 3164444,
...
@responses.activate
def test_droplets_create(mock_client: DigitalOceanClient, mock_client_url):
    expected = {
        "name": "example.com",
        "region": "nyc3",
        "size": "s-1vcpu-1gb",
...
@responses.activate
def test_droplets_get(mock_client: DigitalOceanClient, mock_client_url):
    expected = {
        "droplet": {
            "id": 3164444,
            "name": "example.com",
...
@responses.activate
def test_droplets_delete(mock_client: DigitalOceanClient, mock_client_url):
    responses.add(
        responses.DELETE,
        f"{mock_client_url}/v2/droplets/1",
        status=204,
