...
@responses.activate
def test_destroy_with_associated_resources_selective(mock_client: Client, mock_client_url):
...
@responses.activate
def test_destroy_with_associated_resources_dangerous(mock_client: Client, mock_client_url):
    ...
    resp = mock_client.droplets.destroy_with_associated_resources_dangerous(droplet_id, x_dangerous=True)
