...
@responses.activate
def test_list_tags(mock_client: DigitalOceanClient, mock_client_url):
...
@responses.activate
def test_list_tags_pagination(mock_client: DigitalOceanClient, mock_client_url):
    """Mocks the tags list operation."""
    expected = {
        "tags": [
            {
...
@responses.activate
def test_get_tag(mock_client: DigitalOceanClient, mock_client_url):
...
@responses.activate
def test_create_tag(mock_client: DigitalOceanClient, mock_client_url):
...
@responses.activate
def test_delete_tag(mock_client: DigitalOceanClient, mock_client_url):
...
@responses.activate
def test_assign_resources(mock_client: DigitalOceanClient, mock_client_url):
...
@responses.activate
def test_unassign_resources(mock_client: DigitalOceanClient, mock_client_url):
