...
@responses.activate
def test_list_ssh_keys(mock_client: DigitalOceanClient, mock_client_url):
...
@responses.activate
def test_list_ssh_keys_pagination(mock_client: DigitalOceanClient, mock_client_url):
    """Tests the SSH keys list operation."""
    expected = {
        "ssh_keys": [
            {
...
@responses.activate
def test_get_ssh_keys(mock_client: DigitalOceanClient, mock_client_url):
...
@responses.activate
def test_create_ssh_keys(mock_client: DigitalOceanClient, mock_client_url):
...
@responses.activate
def test_update_ssh_keys(mock_client: DigitalOceanClient, mock_client_url):
    """Tests the SSH keys create operation."""
    expected = {
        "ssh_key": {
            "id": 1234,
...
@responses.activate
def test_delete_ssh_keys(mock_client: DigitalOceanClient, mock_client_url):
...
@responses.activate
def test_ssh_keys_error_response(mock_client: DigitalOceanClient, mock_client_url):
