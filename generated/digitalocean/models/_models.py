...
class Components19JfuwyResponsesAllDropletActionsContentApplicationJsonSchema(Pagination, Meta, Components1Bp6Ru2ResponsesAllDropletActionsContentApplicationJsonSchemaAllof0):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(Components19JfuwyResponsesAllDropletActionsContentApplicationJsonSchema, self).__init__(**kwargs)
        self.actions = kwargs.get('actions', None)
        self.meta = kwargs['meta']
        self.actions = kwargs.get('actions', None)
        self.links = kwargs.get('links', None)
...
class DropletActionChangeKernel(DropletActionTypeEnum):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DropletActionChangeKernel, self).__init__(**kwargs)
...
class DropletActionRebuild(DropletActionTypeEnum):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DropletActionRebuild, self).__init__(**kwargs)
...
class DropletActionRename(DropletActionTypeEnum):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DropletActionRename, self).__init__(**kwargs)
...
class DropletActionResize(DropletActionTypeEnum):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DropletActionResize, self).__init__(**kwargs)
...
class DropletActionRestore(DropletActionTypeEnum):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DropletActionRestore, self).__init__(**kwargs)
        self.image = kwargs.get('image', None)
...
class DropletActionSnapshot(DropletActionTypeEnum):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DropletActionSnapshot, self).__init__(**kwargs)
        self.name = kwargs.get('name', None)
