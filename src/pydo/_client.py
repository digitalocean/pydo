...
class GeneratedClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype prepayment_config: pydo.operations.PrepaymentConfigOperations
    :ivar prepayment_status: PrepaymentStatusOperations operations
    :vartype prepayment_status: pydo.operations.PrepaymentStatusOperations
    ...
    :vartype organizations: pydo.operations.OrganizationsOperations
    ...
    :vartype vpc_routes: pydo.operations.VpcRoutesOperations
    :ivar vpc_subnets: VpcSubnetsOperations operations
    :vartype vpc_subnets: pydo.operations.VpcSubnetsOperations
    :ivar vpc_subnet_routes: VpcSubnetRoutesOperations operations
    :vartype vpc_subnet_routes: pydo.operations.VpcSubnetRoutesOperations
