...
class Batches:
    ...
    def create(self, **kwargs: Any) -> Any:
        ...
        return _wrap_with_id_alias(
            self._client.inference.create_batch(body, **sdk),
    ...
    def get(self, batch_id: str, **kwargs: Any) -> Any:
        ...
        return _wrap_with_id_alias(
            self._client.inference.get_batch(batch_id=batch_id, **kwargs),
            primary_id_field="batch_id",
        )
    ...
    def cancel(self, batch_id: str, **kwargs: Any) -> Any:
        ...
        return _wrap(self._client.inference.cancel_batch(batch_id=batch_id, **kwargs))
