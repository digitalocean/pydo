...
class Files:
    ...
    def create(
        ...
        **kwargs: Any,
        ...
        intent = self._client.inference.create_batch_file({"file_name": name}, **sdk)
    ...
    def content(self, file_id: str, **kwargs: Any) -> _FileContent:
        ...
        """
        response = self._client.inference.get_batch_results(batch_id=file_id, **kwargs)
