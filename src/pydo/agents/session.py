...
class AgentSession:
    ...
    def pause(self) -> Any:
        return self._sessions.pause(self.session_id)

    def resume(self) -> Any:
        return self._sessions.resume(self.session_id)

    def update(self, *, resume_on_topoff: Optional[bool] = None) -> Any:
        """Patch session-scoped settings (e.g. ``resume_on_topoff``)."""
        return self._sessions.update(self.session_id, resume_on_topoff=resume_on_topoff)
    ...
    def exec(
        ...
        *argv: str,
        ...
        return self._sessions.exec_in_sandbox(
            self.session_id,
            argv=argv,
            workdir=workdir,
    ...
    def relay(self, source_raw: Any, *, timeout: Optional[float] = None) -> Any:
        """Forward one native agent-protocol request frame."""
        return self._sessions.relay_request(
    ...
    def create_checkpoint(
        ...
        return self._sessions.create_checkpoint(
    ...
    def list_checkpoints(
        ...
        *,
        ...
        return self._sessions.list_checkpoints(
            self.session_id, page_token=page_token, page_size=page_size
        )

    def get_checkpoint(self, checkpoint_id: str) -> Any:
        return self._sessions.get_checkpoint(self.session_id, checkpoint_id)

    def delete_checkpoint(self, checkpoint_id: str) -> Any:
        return self._sessions.delete_checkpoint(self.session_id, checkpoint_id)

    def rollback(self, checkpoint_id: str) -> Any:
        return self._sessions.rollback_to_checkpoint(self.session_id, checkpoint_id)
